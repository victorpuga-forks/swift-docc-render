...
// The name of the home route. Contains 'documentation-topic' as a substring
// so that existing scroll behavior checks work without modification.
export const homeRouteName = 'documentation-topic-home';
